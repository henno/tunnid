...
<html lang="en">
   <head>
    ...
    <link rel="shortcut icon" href="css/images/timetable.png"/>
    <title>Tunnid</title>
...
$septemberFirst =
    date('m', strtotime('today')) < 9 ?
        date('Y-m-d', strtotime('1st august last year')) :
        date('Y-m-d', strtotime('1st September this year')
        );
$septemberFirstMonday = date('Y-m-d', strtotime('Last Monday of', strtotime($septemberFirst)));
        ...
        <form action="" class="navbar-form navbar-left">
            <div class="form-group">
                <input type="text" name="date_from" id="date_from" class="form-control date"
                       value="<?php echo $thisweek; ?> 08:30" placeholder="Algus">
            </div>
            <div class="form-group">
                <input type="text" name="date_to" id="date_to" class="form-control date"
                       value="<?php echo $nextweek; ?> 22:05" placeholder="Lõpp">
            </div>
            <div class="form-group">
            ...
            <div class="btn-group btn-group-sm">
                <a href="#" class="btn btn-default" id="remove-filters" title="Eemalda filtrid"><i
                        class="glyphicon glyphicon-remove"></i></a>
                <a href="#" class="btn btn-default" id="update-database"
                   title="Uuenda andmebaasi (<?php echo $lastUpdate; ?>)"><i
    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-pills menu-period">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php foreach ($perioodid as $key => $periood): ?>
                            <li><a href="#" class="period" data-start="<?php echo $periood['start'] ?>"
                                   data-end="<?php echo $periood['end'] ?>"><?php echo ($key + 1) . '. periood (' . $periood['start'] . '-' . $periood['end'] . ')' ?></a>
                            </li>
                            <?php
                ...
                <li><a href="#" class="period" data-start="<?php echo $thisweek; ?>"
                       data-end="<?php echo $nextweek; ?>">Jooksev ja järgmine nädal</a></li>
                <li><a href="#" class="period" data-start="<?php echo $perioodid[$currentPeriod]['start']; ?>"
                       data-end="<?php echo $perioodid[$currentPeriod]['end']; ?>">Jooksev periood</a></li>
                <li><a href="#" class="period" data-start="<?php echo @$perioodid[$currentPeriod - 1]['start']; ?>"
                       data-end="<?php echo $perioodid[$currentPeriod]['end']; ?>">Eelmine ja jooksev periood</a></li>
                <li><a href="#" class="period" data-start="<?php echo $septemberFirst; ?>"
                       data-end="<?php echo $perioodid[7]['end']; ?>">Jooksev õppeaasta</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="process-buttons btn-group btn-group-xs">
                <button type="button" class="processed-remove btn btn-danger"><i class="glyphicon glyphicon-remove"></i>
                </button>
                <button type="button" class="processed-apply btn btn-success"><i class="glyphicon glyphicon-ok"></i>
                </button>
            </div>
            ...
            <div class="modal-body">
                <form id="passform" action="" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button id="submit-password" required pattern=".{6,}" class="btn btn-success btn-block">
                                Ok!
                            </button>
                        </div>
                    </div>
